...
try: #//BLOCO DE CÓDIGO
    ...
    client_udp.close() # QUANDO O PROGRAMA FINALIZAR, O MESMO FECHARÁ AUTOMATICAMENTE


except Exception as erro: #AQUI ELE VAI MOSTRAR O ERRO QUE ESTÁ OCORRENDO NO PROGRAMA
    print erro
